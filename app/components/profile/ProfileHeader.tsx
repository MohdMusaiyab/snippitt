...
export default function ProfileHeader({
  ...
  // FIX: Separate refs for mobile and desktop menus
        ...
        <div className="flex flex-col items-center sm:hidden relative">
          ...
          <div className="absolute top-0 right-0 flex items-center gap-0.5">
            <button
              ...
              className="px-1 py-2 text-gray-400 hover:text-gray-600 transition"
            >
              <Share2 size={18} />
            </button>

            {/* FIX: Use mobileMenuRef here */}
            {profileData.isOwner && !isEditing && (
              <div className="relative" ref={mobileMenuRef}>
                ...
                {menuOpen && (
                  <div className="absolute right-0 top-10 w-44 bg-white border border-gray-200 rounded-xl shadow-md overflow-hidden z-50">
                    <button
                      onClick={() => {
                        setIsEditing(true);
                        setMenuOpen(false);
          ...
          <div className="relative mb-3">
            <div className="w-20 h-20 rounded-full border-2 border-white shadow-md overflow-hidden bg-indigo-50 ring-2 ring-indigo-100">
              {avatarSrc ? (
                <Image
                  src={avatarSrc}
              ...
              {isEditing && (
                <button
                  ...
                  className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white rounded-full"
                >
                  <Camera size={18} />
          ...
          {isEditing ? (
            <div className="w-full space-y-1 mb-3">
              ...
              <input
                ...
                className="text-lg font-extrabold text-gray-900 border-b-2 border-indigo-500 outline-none bg-transparent pb-1 w-full text-center"
              />
            </div>
          ) : (
            <div className="text-center mb-1">
              ...
              <span className="flex items-center justify-center gap-1 text-xs text-gray-400 mt-0.5">
                <Calendar size={11} />
                Joined {joinDate}
              </span>
            </div>
            ...
            {isEditing ? (
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 bg-gray-50 rounded-xl border border-gray-200 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 focus:bg-white outline-none transition-all text-sm text-gray-700 resize-none text-center"
                />
              </div>
            ) : (
          ...
          {isEditing && (
            <div className="w-full mt-4 flex gap-2">
              ...
              <button
                ...
                disabled={isSubmitting}
                className="flex-1 py-2.5 rounded-xl bg-primary hover:bg-indigo-700 text-white text-sm font-semibold shadow-sm transition-all disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
          ...
          {/* Stats grid */}
          {!isEditing && (
            <div className="mt-5 pt-4 w-full border-t border-gray-100 grid grid-cols-2 gap-y-3 gap-x-6">
              {[
                {
        ...
        <div className="hidden sm:block">
          <div className="flex items-start gap-4">
            ...
            <div className="relative flex-shrink-0">
              <div className="w-20 h-20 rounded-2xl border-2 border-white shadow-md overflow-hidden bg-indigo-50 ring-2 ring-indigo-100">
                {avatarSrc ? (
                  <Image
                    src={avatarSrc}
                    alt={profileData.username}
                      ...
                      {isEditing ? (
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={handleSaveProfile}
                            disabled={isSubmitting}
                            className="flex items-center gap-2 px-4 py-2 bg-primary hover:bg-indigo-700 text-white rounded-xl text-sm font-semibold shadow-sm transition-all disabled:opacity-50"
                          >
                            {isSubmitting ? (
                              <Loader2 size={14} className="animate-spin" />
                            ) : (
